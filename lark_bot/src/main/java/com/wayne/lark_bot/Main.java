...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            List<String> emails = Arrays.asList("zhangsan@z.com", "lisi@a.com");
            List<String> mobiles = Arrays.asList("13267080069", "13022222222");
            ...
            System.out.println("User Open ID: " + userOpenId);
            ...
            bot.downloadImage(imageKey, "/Users/wayne/Downloads/lark/test.png");

            String fileKey = bot.uploadFile("/Users/wayne/Downloads/xr2-platform.jks", "stream");
            bot.sendFileToChat(chatIds.get(0), fileKey);
            bot.downloadFile(fileKey, "/Users/wayne/Downloads/lark/test.jks");
